...
export const api = {
    ...
    enableAccount: (username: string | undefined): ApiResponseType<AccountType> => {
        return apiWithConfig.patch(`/accounts/enable/${username}`)
    },
    disableAccount: (username: string | undefined): ApiResponseType<AccountType> => {
    ...
    deleteClient: (username: string | undefined): ApiResponseType<ClientType> => {
