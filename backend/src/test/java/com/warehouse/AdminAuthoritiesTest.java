...
public class AdminAuthoritiesTest {
    ...
    public void testUpdateAdminPassword() {
        given()
                .header("Authorization", token)
                .contentType("application/json")
                .body("{\"username\":\"testAdmin\",\"password\":\"Test1234!\"}")
                .when()
                .put(accountUrl + "/testAdmin")
                .then()
                .statusCode(200);
    }
    ...
    public void testDisableUserAccount() {
        given()
                .header("Authorization", token)
                .when()
                .patch(accountUrl + "/enable/testUser")
                .then()
                .statusCode(200);
    }
    ...
    public void testAddReservation() {
        ...
        jsonObject.put("deliveryType", "delivery");
